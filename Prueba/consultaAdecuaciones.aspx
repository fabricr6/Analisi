<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultaAdecuaciones.aspx.cs" Inherits="Prueba.consultaAdecuaciones" %>
...
<head runat="server">
    ...
    <title>Consulta por Adecuacion </title>
</head>
...
<body>
    ...
    <form id="formConsultaAdecuacion" runat="server">
        <div>
                        ...
                        <div class="tarjetaFrm ">
                            ...
                            <article class="body">
                                <div class="jumbotron jumbotron-fluid">
                                    <div class="container">
                                        <h3 class="display-4">Consulta por Adecuaciones </h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="selectASignaturaAdecuacion">
                                        <option>--Seleccione--</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="selectAulaAdecuacion">
                                        <option>--Seleccione--</option>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <asp:GridView ID="GridconsultaAdecuaciones" runat="server"></asp:GridView>
                                        </tbody>
                                    </table>
                                </div>
